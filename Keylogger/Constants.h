#ifndef POCKET_CONSTANTS_H
#define POCKET_CONSTANTS_H
...
class KeyPair{
    public:
        KeyPair (string vk = "", string name = "") : VKName (move(vk)), Name (move(name)){};
        string VKName;
        string Name;
...
map<int, KeyPair> Keys::KEYS = {
        // {system (hex), system name, common name}
